...
quick answer follows. (In the meantime it got longer ...)

Let me know if you have more questions.

Note that the '::' notation is kind of "intelligent": http://docutils.sourceforge.net/docs/ref/rst/restructuredtext.html#literal-blocks
It is the least disturbing markup for a code-block. But you have to setup the proper highlighting by a directive before, like

.. highlight:: none
.. highlight:: guess
.. highlight:: php

You can use .. highlight:: as often as you want. It's in effect until the end of the document it appears in.


With:

(a) use default highlighting, get ONE ':' in output

This is a list of all changes in this release::



(b) use default highlighting, get NO ':' in output

This is a list of all changes in this release     ::

 

(c) use default highlighting, get NO ':' and NO extra line in output
...
.. Set default highlight style to none.
   This will be in effect IN THIS FILE until the next 'set default':
...
(1) For more information see: http://www.sphinx-doc.org/en/1.4.8/markup/code.html#showing-code-examples
...
With "guess" Pygments uses the first language that doesn't throw a parsing error.


(2) Visit http://pygments.org/demo/ for online experiments

(3) If you have installed Sphinx locally::

   $ pygmentize -L | less

Following the list of lexers (=languages):
...
ToDo -> Martin:
This info should be added somewhere to https://docs.typo3.org/typo3cms/RenderTYPO3DocumentationGuide/

Hau rein!

All the best from Münster!

PS: If you really want to reach me - don't rely on Twiter ;-)

-- 
Martin Bless
TYPO3 Documentation Team Leader
